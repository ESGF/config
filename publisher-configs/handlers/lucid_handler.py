"""Handle LUCID data file metadata
...
#!NOTE: This handler doesn't support product dection for LUCID.  
...
cmorTables = ['3hr', '6hrLev', '6hrPlev', 'Amon', 'LImon', 'Lmon', 'OImon', 'Oclim', 'Omon', 'Oyr', 'aero', 'cf3hr', 'cfDay', 'cfMon', 'cfOff', 'cfSites', 'day', 'fx']
...
class LUCIDHandler(BasicHandler):
