"""Handle EUCLIPSE data file metadata
...
#!NOTE: This handler doesn't support product dection for EUCLIPSE.  
...
class EUCLIPSEHandler(BasicHandler):
    ...
    def validateFile(self, fileobj):
        ...
        if not fileobj.hasAttribute('project_id'):
            ...
            result =  (project_id[:8]==PROJECT_ID)
    ...
    def readContext(self, cdfile, model=''):
        ...
        #!WARNING: All IPSL-EUCLIPSE data goes into output
