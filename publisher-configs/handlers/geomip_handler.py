"""Handle GeoMIP data file metadata
...
#!NOTE: This handler doesn't support product dection for GeoMIP.  
...
cmorTables = ['3hr', '6hrPlev', 'aero', 'Amon', 'cfDay','cfMon','day','fx','Lmon','OImon','Omon','Oyr']
...
class GeoMIPHandler(BasicHandler):
    ...
    def validateFile(self, fileobj):
        ...
        if not fileobj.hasAttribute('project_id'):
            ...
            result =  (project_id[:6]==PROJECT_ID)
    ...
    def readContext(self, cdfile, model=''):
        ...
        #!WARNING: All IPSL-GeoMIP data goes into output
